...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-tile glass-panel-strong p-1 text-popover-foreground data-[state=open]:animate-tm-pop-in data-[state=closed]:animate-tm-pop-out origin-(--radix-dropdown-menu-content-transform-origin)",
      className
    )}
    {...props}
  />
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-50 max-h-[var(--radix-dropdown-menu-content-available-height)] min-w-[8rem] overflow-y-auto overflow-x-hidden rounded-tile glass-panel-strong p-1 text-popover-foreground",
        "data-[state=open]:animate-tm-pop-in data-[state=closed]:animate-tm-pop-out origin-(--radix-dropdown-menu-content-transform-origin)",
        className
      )}
      {...props}
    />
